          ...
          >
            <div className="relative">
              <input
                ...
                name="name"
                required
                className="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-white transition focus:outline-none focus:border-orange-400 focus:bg-blue-500/5"
                placeholder="Name..."
                onChange={(e) =>
